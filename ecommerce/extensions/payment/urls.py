...
from ecommerce.extensions.payment.views import PaymentFailedView, SDNFailure, cybersource, paypal, stripe, alipayviews
...
ALIPAY_URLS = [
    url(r'^notify/$', alipayviews.AlipayPaymentNotifyView.as_view(), name='notify'),
    url(r'^return/$', alipayviews.AlipayPaymentResultView.as_view(), name='return'),
]
